 ...
 hideShowPassword() {
  ...
  public async submitpassword(){
    ...
    console.log(this.authService.regform)
     ...
     let data=Object.assign(this.authService.regform,{"password":this.pass2})
     this.authService.register(data).subscribe((res:any)=>{
       console.log(res)
     let udata=Object.assign(this.authService.userdetails,{"userid":res._id})
     console.log(udata)
     this.authService.adduserdetails(udata).subscribe((res:any)=>{
       console.log(res)
